...
export default function UpdataCommodity(props) {
	// console.log( props.formData[Object.keys(props.formData)] && props.formData[Object.keys(props.formData)].title   )
  ...
  return (
    ...
    <Container component="main" maxWidth="xs">
		...
		<div className={classes.paper}>
	        ...
	        <Formik
	          initialValues={{
		          title: props.formData[Object.keys(props.formData)] && props.formData[Object.keys(props.formData)].title  , 
		          subName: props.formData[Object.keys(props.formData)] && props.formData[Object.keys(props.formData)].subName, 
		          price: props.formData[Object.keys(props.formData)] && props.formData[Object.keys(props.formData)].price , 
		          inventory : props.formData[Object.keys(props.formData)] && props.formData[Object.keys(props.formData)].inventory  , 
		          content : props.formData[Object.keys(props.formData)] && props.formData[Object.keys(props.formData)].content ,
		          'sevenElevenPickUpPayment' :props.formData[Object.keys(props.formData)] && props.formData[Object.keys(props.formData)].freight.sevenElevenPickUpPayment ,
		          'pickUpPayment' : props.formData[Object.keys(props.formData)] && props.formData[Object.keys(props.formData)].freight.pickUpPayment ,
		          'sevenElevenPickUp' : props.formData[Object.keys(props.formData)] && props.formData[Object.keys(props.formData)].freight.sevenElevenPickUp ,
		          'mailing': props.formData[Object.keys(props.formData)] && props.formData[Object.keys(props.formData)].freight.mailing ,
		          'homeDelivery' : props.formData[Object.keys(props.formData)] && props.formData[Object.keys(props.formData)].freight.homeDelivery ,
	      	}}
	          validate={values => {
	            let errors = {};
	            if (!values.title) {
	          ...
	          {({
	            ...
	            <form onSubmit={handleSubmit} className={classes.form} noValidate >
				      ...
				      />       
					    ...
					    <div style={{
					    	backgroundImage:`url(${props.formData[Object.keys(props.formData)] && props.formData[Object.keys(props.formData)].productPicture})` ,
							height:'400px',
